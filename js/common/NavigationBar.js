...
import { ViewPropTypes, StyleSheet, Text, StatusBar, View, Platform } from 'react-native';
import { PropTypes } from 'prop-types';

const NAV_BAR_HEIGHY_IOS = 44; //导航栏在ios中的高度,
const NAV_BAR_HEIGHY_ANDROID = 50; //导航栏在andriod中的高度
...
const styles = StyleSheet.create({
	...
	navBar: {
		...
		height: Platform.OS === 'ios' ? NAV_BAR_HEIGHY_IOS : NAV_BAR_HEIGHY_ANDROID
	},
